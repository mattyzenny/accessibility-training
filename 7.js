...
/***/ "bG0z":
/*!*****************************************************************************************************!*\
  !*** /Users/mattyZ/Desktop/Projects/forked-cel-library/dist-stencil/esm/cel-error-message.entry.js ***!
  \*****************************************************************************************************/
/*! exports provided: cel_error_message */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cel_error_message", function() { return CelErrorMessage; });
...
const CelErrorMessage = class {
  constructor(hostRef) {
    ...
    this.errorMessageButtonClick = Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "celErrorMessageButtonClick", 7);
    this.errorIcon = 'error-cloud.svg';
    this.errorMessage = 'Sorry, something went wrong';
    this.directions = undefined;
    this.celIconBaseUrl = '';
    this.hasCustomDirection = false;
    this.hasErrorCode = undefined;
    this.errorCodeLabel = 'Error Code';
    this.errorCode = '#####';
    this.errorMessageAriaLabel = undefined;
    this.showComponentLoadInfo = false;
    this.hideErrorIcon = false;
    this.hasButton = false;
    this.buttonLabel = undefined;
    this.buttonAriaLabel = undefined;
    this.buttonIdentifier = undefined;
    this.hasLink = false;
    this.errorLinkLabel = undefined;
    this.errorLinkHref = undefined;
    this.errorLinkAriaLabel = undefined;
    this.tabindex = 0;
  }
  connectedCallback() {
    this.cel_icon = Object(_utils_194224bf_js__WEBPACK_IMPORTED_MODULE_1__["t"])('cel-icon', 'cel-error-message', this.el);
    this.cel_button = Object(_utils_194224bf_js__WEBPACK_IMPORTED_MODULE_1__["t"])('cel-button', 'cel-error-message', this.el);
    this.cel_text_link = Object(_utils_194224bf_js__WEBPACK_IMPORTED_MODULE_1__["t"])('cel-text-link', 'cel-error-message', this.el);
  }
  componentDidLoad() {
  ...
  buttonPress() {
    this.errorMessageButtonClick.emit(this.buttonIdentifier);
  }
  render() {
    return (Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["H"], { "data-cel-version": '9.0.2', role: 'alert', "aria-label": this.errorMessageAriaLabel }, this.hideErrorIcon ?
      null :
      Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])(this.cel_icon, { class: "error-icon", "data-name": "error-cloud", "data-src": this.celIconBaseUrl ? `${this.celIconBaseUrl}${this.errorIcon}` : '', "data-size": _cel_icon_constants_33baae7b_js__WEBPACK_IMPORTED_MODULE_2__["a"].CUSTOM, "aria-hidden": "true", "data-padding": "0" }), Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("p", { class: 'error' }, this.errorMessage), this.hasCustomDirection ? (Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)) : (Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("p", { class: 'directions' }, this.directions)), this.hasErrorCode && (Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("p", { class: 'error-code' }, this.errorCodeLabel, ": ", this.errorCode)), this.hasButton ?
      Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])(this.cel_button, { class: "error-message-button", "data-button-size": _cel_icon_constants_33baae7b_js__WEBPACK_IMPORTED_MODULE_2__["b"].SMALL, "data-label": this.buttonLabel, onClick: () => this.buttonPress(), "data-button-aria-label": this.buttonAriaLabel, "data-identifier": this.buttonIdentifier }) : null, this.hasLink ?
      Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])(this.cel_text_link, { class: "error-message-link", "data-label": this.errorLinkLabel, "data-link-href": this.errorLinkHref, "data-text-link-aria-label": this.errorLinkAriaLabel }) : null));
  }
  get el() { return Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
};
CelErrorMessage.style = celErrorMessageCss;
