...
/***/ "5KkE":
/*!********************************************************************************************!*\
  !*** /Users/mattyZ/Desktop/Projects/forked-cel-library/dist-stencil/esm/cel-icon.entry.js ***!
  \********************************************************************************************/
/*! exports provided: cel_icon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cel_icon", function() { return CelIcon; });
...
const CelIcon = class {
  constructor(hostRef) {
    ...
    this.color = _cel_icon_constants_33baae7b_js__WEBPACK_IMPORTED_MODULE_2__["C"].PRIMARY;
    this.tooltipLabel = '';
    this.size = _cel_icon_constants_33baae7b_js__WEBPACK_IMPORTED_MODULE_2__["a"].MEDIUM;
    this.lazy = false;
  ...
  render() {
     ...
     */
    return (Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["H"], { "data-cel-version": '9.0.2', "aria-label": iconAriaLabel !== undefined && !this.hasAriaHidden()
        ? iconAriaLabel
        : null, role: this.dialogCloseIconRole, class: {
        ...Object(_utils_194224bf_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.color),
        ['cel-pulse']: !!this.pulse,
        ['cel-spin']: !!this.spin,
        [`icon-${this.size}`]: !!this.size,
      }, ...inheritedAttributes }, this.svgContent ? (Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { title: this.tooltipLabel ? this.tooltipLabel : null, class: 'icon-inner', innerHTML: this.svgContent })) : (Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: 'icon-inner' }))));
  }
