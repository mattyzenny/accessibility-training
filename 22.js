...
/***/ "tp5v":
/*!**********************************************************************************************************!*\
  !*** /Users/mattyZ/Desktop/Projects/forked-cel-library/dist-stencil/esm/cel-notification-board.entry.js ***!
  \**********************************************************************************************************/
/*! exports provided: cel_notification_board */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cel_notification_board", function() { return CelNotificationBoard; });
...
const CelNotificationBoard = class {
  ...
  connectedCallback() {
    this.cel_notification_item = Object(_utils_194224bf_js__WEBPACK_IMPORTED_MODULE_1__["t"])('cel-notification-item', 'cel-notification-board', this.el);
    this.cel_loader = Object(_utils_194224bf_js__WEBPACK_IMPORTED_MODULE_1__["t"])('cel-loader', 'cel-notification-board', this.el);
  }
  componentDidLoad() {
    var _a;
    if (!this.hideDismissAll) {
      (_a = this.dismissAllEl) === null || _a === void 0 ? void 0 : _a.focus();
    }
  }
  render() {
    return (Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["H"], { "data-cel-version": '9.0.2' }, Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { role: "region", "aria-label": this.showLoader ? this.loaderAriaLabel : this.headerLabel, class: "notification-container" }, Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "container-header" }, Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("p", null, this.headerLabel), this.hideDismissAll ?
      null :
      Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { ref: (el) => (this.dismissAllEl = el), class: ['dismiss-all-button', this.disableDismissAll && 'disabled-button'].join(' '), "aria-disabled": this.disableDismissAll ? 'true' : 'false', onClick: () => this.handleDismissAllClick(), "aria-label": this.dismissAllAriaLabel }, this.dismissAllLabel)), Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: ["notification-menu", this.hideFooter && 'footer-hidden'].join(' '), role: this.showLoader ? null : 'feed' }, this.showLoader ?
      Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])(this.cel_loader, { class: 'notification-loader', "data-loader-aria-label": this.loaderAriaLabel, "data-is-live-region": 'true' })
      : this.notificationItems.map((item, index) => (Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])(this.cel_notification_item, { "data-notification-message": item.notificationMessage, "data-notification-second-message": item.notificationSecondMessage, "data-notification-subtext": item.notificationSubtext, "data-notification-href": item.notificationHref, "data-tag-label": item.tagLabel, "data-show-action-button": item.showActionButton, "data-notification-type": item.notificationType, "data-action-button-aria-label": item.actionButtonAriaLabel, "data-notification-id": item.notificationId, "data-action-button-label": item.actionButtonLabel, "data-notification-index": index }))), this.hideFooter || this.showLoader ?
      null :
      Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("article", { "aria-setsize": "-1", "aria-label": this.footerAriaLabel }, Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["h"])("a", { "aria-disabled": this.disableFooter ? 'true' : 'false', class: ['container-footer', this.disableFooter && 'disabled-footer'].join(' '), href: this.disableFooter ? null : this.footerHref, onClick: () => this.handleFooterClick() }, this.footerLabel))))));
  }
  get el() { return Object(_index_9a8c46b4_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
};
CelNotificationBoard.style = celNotificationBoardCss;
