...
/***/ "FHea":
/*!***************************************************************************************************!*\
  !*** /Users/mattyZ/Desktop/Projects/forked-cel-library/dist-stencil/esm/cel-radio-popup.entry.js ***!
  \***************************************************************************************************/
/*! exports provided: cel_radio_popup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cel_radio_popup", function() { return CelRadioPopup; });
...
const CelRadioPopup = class {
  ...
  /**
   * Listens to close cel-radio-menu on esc key press
   */
  handleCelRadioMenuCloseEvent(event) {
    var _a;
    if ((_a = event.detail) === null || _a === void 0 ? void 0 : _a.isClose) {
      this.closeMenu();
      event.detail.parentTargetElement.shadowRoot.querySelector('button').focus();
    }
  }
  /**
   * Listens to celRadioMenuItemSelectedEvent
   */
  handleCelRadioMenuItemSelected(event) {
    this.closeMenu();
    this.itemSelected.emit(event.detail);
    this.buttonElement.shadowRoot.querySelector('button').focus();
  }
  connectedCallback() {
    this.cel_radio_menu = Object(_utils_194224bf_js__WEBPACK_IMPORTED_MODULE_1__["t"])('cel-radio-menu', 'cel-radio-popup', this.el);
    this.cel_icon_button = Object(_utils_194224bf_js__WEBPACK_IMPORTED_MODULE_1__["t"])('cel-icon-button', 'cel-radio-popup', this.el);
  }
  toggleOpen() {
    if (!this.buttonDisabled) {
      this.open = !this.open;
      this.buttonClicked.emit({ isOpen: this.open });
    }
  }
  closeMenu() {
    this.open = false;
