...
/***/ "e0UW":
/*!*********************************************************************************************************!*\
  !*** /Users/mattyZ/Desktop/Projects/forked-cel-library/dist-stencil/esm/cel-rich-text-toolbar.entry.js ***!
  \*********************************************************************************************************/
/*! exports provided: cel_rich_text_toolbar */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cel_rich_text_toolbar", function() { return CelRichTextToolbar; });
...
const CelRichTextToolbar = class {
  constructor(hostRef) {
    ...
    this.buttonPadding = _cel_rich_text_interface_83978736_js__WEBPACK_IMPORTED_MODULE_2__["i"].regularViewPadding;
    this.bold = false;
    this.italic = false;
  ...
  handleCelButtonOnClick(eventObj) {
    ...
    const { bold, italic, underline, bullet, ordered } = _cel_rich_text_interface_83978736_js__WEBPACK_IMPORTED_MODULE_2__["t"];
    switch (toolType) {
      case bold:
      case italic:
      case underline:
  ...
  handleArrowKeySelection(event) {
    const arrowConstants = [_constants_a06dfd18_js__WEBPACK_IMPORTED_MODULE_3__["A"], _constants_a06dfd18_js__WEBPACK_IMPORTED_MODULE_3__["c"], _constants_a06dfd18_js__WEBPACK_IMPORTED_MODULE_3__["e"], _constants_a06dfd18_js__WEBPACK_IMPORTED_MODULE_3__["d"]];
    if (!arrowConstants.includes(event.code))
      return;
    this.handleKeyDown(event);
  }
  connectedCallback() {
    this.cel_rich_text_toolbar_icon_button = Object(_utils_194224bf_js__WEBPACK_IMPORTED_MODULE_1__["t"])('cel-rich-text-toolbar-icon', 'cel-rich-text-toolbar', this.el);
  }
  componentWillLoad() {
    const itemList = [];
    _cel_rich_text_interface_83978736_js__WEBPACK_IMPORTED_MODULE_2__["r"].forEach((item) => {
  ...
  handleResize() {
    ...
    if (rteWidth <= 320) {
      this.buttonPadding = _cel_rich_text_interface_83978736_js__WEBPACK_IMPORTED_MODULE_2__["i"].mobileViewPadding;
    }
    else {
      this.buttonPadding = _cel_rich_text_interface_83978736_js__WEBPACK_IMPORTED_MODULE_2__["i"].regularViewPadding;
    }
